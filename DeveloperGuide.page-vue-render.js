...
with(this){return _c('p',[_v("How command execution works in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component:")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("How autocomplete execution works in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component:")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Trie")]),_v(" class is a data structure that allows for efficient prefix matching of strings. It is used in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AutoComplete")]),_v(" feature to suggest completions for user input."),_c('br'),_v("\nWe added the ability to search for the first word that matches a given prefix. This is useful for the autocomplete feature, where we want to suggest the first word that matches the prefix.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delstu e1234567")]),_v(" command to delete student with nusnet ID as e1234567 from the contact book.\nThe "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delstu")]),_v("\ncommand\ncalls\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitAddressBook()")]),_v(", causing the modified state of the contact book after the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delstu e1234567")]),_v(" command\nexecutes to\nbe saved in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressBookStateList")]),_v(", and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" is shifted to the newly inserted contact book state.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Step 5. The user wants to set the course name. He enters the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("setcrs CS2103T")]),_v(", causing the course name to appear on the main window's title.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": All in one Address book managing student’s progress in the course, by means of participation, grades, and other course specific attributes of an NUS CS class. Can quickly find information, filter and sort with keyboard shortcuts.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("name/rename the CS course that I am tutoring this semester")]),_v(" "),_c('td',[_v("keep track of the module I am teaching")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("add a student to the CS course that I am tutoring that semester to my class")]),_v(" "),_c('td',[_v("keep track of him or her")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("view all students from my class")]),_v(" "),_c('td',[_v("view details about all of them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("mark attendance for a student in my class")]),_v(" "),_c('td',[_v("keep track of who's present")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("unmark attendance for a student in my class")]),_v(" "),_c('td',[_v("keep track of who is absent")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("delete a student")]),_v(" "),_c('td',[_v("remove a student if he or she leaves the class")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("know all the commands of the contact book")]),_v(" "),_c('td',[_v("use it effectively")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TA Pro")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Delete a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete a specific student based on NUSNet ID.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. No such student exists.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. AddressBook shows an error message.")])]),_v(" "),_c('li',[_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a student, providing the name and NUSNet ID as compulsory information, with the phone number being optional.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Name/Rename CS Course")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to name or rename a CS course by specifying the course name and the new name if applicable.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: View All Students")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view a list of all students.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Mark Attendance")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to mark attendance for a student by providing the student's NUSNet ID.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Un-mark Attendance")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to un-mark attendance for a student by providing the student's NUSNet ID.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Know Commands for the Address Book")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view the list of available commands for the AddressBook.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: Autocompletion of command inputs")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User focuses on the command box.")])]),_v(" "),_c('li',[_c('p',[_v("User presses the autocompletion hotkey.")])]),_v(" "),_c('li',[_c('p',[_v("Autocompleted command is shown in the command box.\nUse case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. No autocompletion is available for the current input.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. No action is taken.")])]),_v(" "),_c('li',[_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("CS")]),_v(": Computer Science")]),_v(" "),_c('li',[_c('strong',[_v("NUS")]),_v(": National University of Singapore")]),_v(" "),_c('li',[_c('strong',[_v("TA")]),_v(": Teaching Assistant")]),_v(" "),_c('li',[_c('strong',[_v("NUSNet ID")]),_v(": A unique identifier for each student in NUS")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a student with NUSNet ID e0123456")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: No student with NUSNet ID e0123456 in the contact book.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addstu n/John Doe p/98765432 e/johndoe@example.com nn/e0123456 a/311, Clementi Ave 2, #02-25 t/friends t/owesMoney")])]),_v(" "),_c('p',[_v("Expected: Student with NUSNet ID "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("e0123456")]),_v(" is added to the contact book. Details of the added contact\nshown in the status message.")])])])]),_v(" "),_c('li',[_c('p',[_v("Adding a student with NUSNet ID e0123457")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: No student with NUSNet ID e0123457 in the contact book.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addstu n/Mary Jane p/91234911 e/janemary@example.com nn/e0123457 a/312, Clementi St 1, #03-25 t/friends t/owesTutorial2")])]),_v(" "),_c('p',[_v("Expected: Student with NUSNet ID "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("e0123457")]),_v(" is added to the contact book. Details of the added contact\nshown in the status message.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Deleting a student")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Contact book contains at least one student with NUSNet ID e0123456.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete e0123456")]),_c('br'),_v("\nExpected: Student with NUSNet ID "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("e0123456")]),_v(" is deleted from the contact book. Details of the deleted contact\nshown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is not an NUSNet ID of a student\nin TA Pro)"),_c('br')])])])]),_v(" "),_c('li',[_c('p',[_c('em',[_v("{ more test cases …​ }")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Marking attendance for a student")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Contact book contains at least one student with NUSNet ID e0123456.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("mark nn/e0123456 wk/1")]),_c('br'),_v("\nExpected: Student with NUSNet ID "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("e0123456")]),_v(" is marked as 'present' from the contact book, depicted on that student's card.\nDetails of the marked contact shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect mark commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("mark")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("mark x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("mark nn/e0123456")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("mark wk/1")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("mark e0123456 1")]),_v(",  "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is not an NUSNet ID of a student\nin TA Pro)"),_c('br')])])])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"setting-the-course"}},[_v("Setting the course"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#setting-the-course","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Setting a course")]),_v(" "),_c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("setcrs CS2103")]),_c('br'),_v("\nEnter setcrs followed by a whitespace, followed by a course code in the format "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XXYYYYZ")]),_v(", where "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("X")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Z")]),_v(" can be any letter\nin upper or lower case, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("YYYY")]),_v(" can be any 4 digit number and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Z")]),_v(" is optional.\nExpected: The main window's title is set as the course code provided")])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Why does "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(" command use "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("INDEX")]),_v(" as identifier instead fo "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NUSNet ID")]),_v("?")])}
},function anonymous(
) {
